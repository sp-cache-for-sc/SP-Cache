...
struct RepartitionCommandTOptions {}
struct RepartitionCommandTResponse {}
...
service FileSystemWorkerClientService extends common.AlluxioService {
  ...
  SessionFileSystemHeartbeatTResponse sessionFileSystemHeartbeat(
    ...
    throws (1: exception.AlluxioTException e)
  RepartitionCommandTResponse RepartitionCommand(1: i32 fileId,
                                   2: list<i32> workerIds
                                   3: RepartitionCommandTOptions options,
      )
       throws(1:exception.AlluxioTException e)
}
