...
service FileSystemMasterClientService extends common.AlluxioService {
  ...
  /** Trigger Repartition for tests**/
  RepartitionTResponse spRepartition(1: RepartitionTOptions options,)
    throws(1: exception.AlluxioTException e)

  /** Trigger getting K values for tests**/
  GetKTResponse getK(1: GetKTOptions options,)
        throws(1: exception.AlluxioTException e)
}

struct RepartitionTResponse{}
struct RepartitionTOptions{
    1: optional bool parallel
}

struct GetKTResponse{}
struct GetKTOptions{}
