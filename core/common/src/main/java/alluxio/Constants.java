...
public final class Constants {
  ...
  public static final long FILE_SYSTEM_WORKER_MASTER_SERVICE_VERSION = 2;
  ...
  public static final String FILE_SYSTEM_WORKER_MASTER_SERVICE_NAME = "FileSystemWorkerMaster";
