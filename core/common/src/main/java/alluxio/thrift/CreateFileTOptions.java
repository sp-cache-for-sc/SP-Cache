...
public class CreateFileTOptions implements org.apache.thrift.TBase<CreateFileTOptions, CreateFileTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<CreateFileTOptions> {
  ...
  private static final org.apache.thrift.protocol.TField K_VALUE_FOR_SP_FIELD_DESC = new org.apache.thrift.protocol.TField("kValueForSP", org.apache.thrift.protocol.TType.I32, (short)7);
  ...
  private int kValueForSP; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    K_VALUE_FOR_SP((short)7, "kValueForSP");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // TTL_ACTION
          return TTL_ACTION;
        case 7: // K_VALUE_FOR_SP
          return K_VALUE_FOR_SP;
        default:
          return null;
      }
    }
  ...
  private static final int __KVALUEFORSP_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.BLOCK_SIZE_BYTES,_Fields.PERSISTED,_Fields.RECURSIVE,_Fields.TTL,_Fields.MODE,_Fields.TTL_ACTION,_Fields.K_VALUE_FOR_SP};
  ...
  static {
    ...
    tmpMap.put(_Fields.K_VALUE_FOR_SP, new org.apache.thrift.meta_data.FieldMetaData("kValueForSP", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public CreateFileTOptions(CreateFileTOptions other) {
    ...
    this.kValueForSP = other.kValueForSP;
  }
  ...
  public int getKValueForSP() {
    return this.kValueForSP;
  }

  public CreateFileTOptions setKValueForSP(int kValueForSP) {
    this.kValueForSP = kValueForSP;
    setKValueForSPIsSet(true);
    return this;
  }

  public void unsetKValueForSP() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __KVALUEFORSP_ISSET_ID);
  }

  /** Returns true if field kValueForSP is set (has been assigned a value) and false otherwise */
  public boolean isSetKValueForSP() {
    return EncodingUtils.testBit(__isset_bitfield, __KVALUEFORSP_ISSET_ID);
  }

  public void setKValueForSPIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __KVALUEFORSP_ISSET_ID, value);
  }
  ...
  public boolean equals(CreateFileTOptions that) {
    ...
    boolean this_present_kValueForSP = true && this.isSetKValueForSP();
    boolean that_present_kValueForSP = true && that.isSetKValueForSP();
    if (this_present_kValueForSP || that_present_kValueForSP) {
      if (!(this_present_kValueForSP && that_present_kValueForSP))
        return false;
      if (this.kValueForSP != that.kValueForSP)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_kValueForSP = true && (isSetKValueForSP());
    list.add(present_kValueForSP);
    if (present_kValueForSP)
      list.add(kValueForSP);
  ...
  public int compareTo(CreateFileTOptions other) {
    ...
    lastComparison = Boolean.valueOf(isSetKValueForSP()).compareTo(other.isSetKValueForSP());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetKValueForSP()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.kValueForSP, other.kValueForSP);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetKValueForSP()) {
      if (!first) sb.append(", ");
      sb.append("kValueForSP:");
      sb.append(this.kValueForSP);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class CreateFileTOptionsStandardScheme extends StandardScheme<CreateFileTOptions> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, CreateFileTOptions struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // K_VALUE_FOR_SP
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.kValueForSP = iprot.readI32();
              struct.setKValueForSPIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CreateFileTOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKValueForSP()) {
        oprot.writeFieldBegin(K_VALUE_FOR_SP_FIELD_DESC);
        oprot.writeI32(struct.kValueForSP);
        oprot.writeFieldEnd();
      }
