...
public class FileSystemWorkerClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
    ...
    public RepartitionCommandTResponse RepartitionCommand(int fileId, List<Integer> workerIds, RepartitionCommandTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void RepartitionCommand(int fileId, List<Integer> workerIds, RepartitionCommandTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public RepartitionCommandTResponse RepartitionCommand(int fileId, List<Integer> workerIds, RepartitionCommandTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_RepartitionCommand(fileId, workerIds, options);
      return recv_RepartitionCommand();
    }

    public void send_RepartitionCommand(int fileId, List<Integer> workerIds, RepartitionCommandTOptions options) throws org.apache.thrift.TException
    {
      RepartitionCommand_args args = new RepartitionCommand_args();
      args.setFileId(fileId);
      args.setWorkerIds(workerIds);
      args.setOptions(options);
      sendBase("RepartitionCommand", args);
    }

    public RepartitionCommandTResponse recv_RepartitionCommand() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      RepartitionCommand_result result = new RepartitionCommand_result();
      receiveBase(result, "RepartitionCommand");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.e != null) {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "RepartitionCommand failed: unknown result");
    }
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void RepartitionCommand(int fileId, List<Integer> workerIds, RepartitionCommandTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      RepartitionCommand_call method_call = new RepartitionCommand_call(fileId, workerIds, options, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class RepartitionCommand_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int fileId;
      private List<Integer> workerIds;
      private RepartitionCommandTOptions options;
      public RepartitionCommand_call(int fileId, List<Integer> workerIds, RepartitionCommandTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.fileId = fileId;
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("RepartitionCommand", org.apache.thrift.protocol.TMessageType.CALL, 0));
        RepartitionCommand_args args = new RepartitionCommand_args();
        args.setFileId(fileId);
        args.setWorkerIds(workerIds);
        args.setOptions(options);
      ...
      public RepartitionCommandTResponse getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_RepartitionCommand();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("RepartitionCommand", new RepartitionCommand());
      return processMap;
    }
    ...
    public static class RepartitionCommand<I extends Iface> extends org.apache.thrift.ProcessFunction<I, RepartitionCommand_args> {
      public RepartitionCommand() {
        super("RepartitionCommand");
      }

      public RepartitionCommand_args getEmptyArgsInstance() {
        return new RepartitionCommand_args();
      }
      ...
      public RepartitionCommand_result getResult(I iface, RepartitionCommand_args args) throws org.apache.thrift.TException {
        RepartitionCommand_result result = new RepartitionCommand_result();
        try {
          result.success = iface.RepartitionCommand(args.fileId, args.workerIds, args.options);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class RepartitionCommand<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, RepartitionCommand_args, RepartitionCommandTResponse> {
      public RepartitionCommand() {
        super("RepartitionCommand");
      }
      ...
      public AsyncMethodCallback<RepartitionCommandTResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<RepartitionCommandTResponse>() { 
          public void onComplete(RepartitionCommandTResponse o) {
            RepartitionCommand_result result = new RepartitionCommand_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, RepartitionCommand_args args, org.apache.thrift.async.AsyncMethodCallback<RepartitionCommandTResponse> resultHandler) throws TException {
        iface.RepartitionCommand(args.fileId, args.workerIds, args.options,resultHandler);
      }
    }
  ...
  public static class RepartitionCommand_args implements org.apache.thrift.TBase<RepartitionCommand_args, RepartitionCommand_args._Fields>, java.io.Serializable, Cloneable, Comparable<RepartitionCommand_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RepartitionCommand_args");
    ...
    private static final org.apache.thrift.protocol.TField WORKER_IDS_FIELD_DESC = new org.apache.thrift.protocol.TField("workerIds", org.apache.thrift.protocol.TType.LIST, (short)2);
    private static final org.apache.thrift.protocol.TField OPTIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("options", org.apache.thrift.protocol.TType.STRUCT, (short)3);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new RepartitionCommand_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new RepartitionCommand_argsTupleSchemeFactory());
    }

    private int fileId; // required
    private List<Integer> workerIds; // required
    private RepartitionCommandTOptions options; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      FILE_ID((short)1, "fileId"),
      WORKER_IDS((short)2, "workerIds"),
      OPTIONS((short)3, "options");
    ...
    static {
      ...
      tmpMap.put(_Fields.WORKER_IDS, new org.apache.thrift.meta_data.FieldMetaData("workerIds", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
      tmpMap.put(_Fields.OPTIONS, new org.apache.thrift.meta_data.FieldMetaData("options", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RepartitionCommandTOptions.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RepartitionCommand_args.class, metaDataMap);
    }

    public RepartitionCommand_args() {
    }

    public RepartitionCommand_args(
      int fileId,
      List<Integer> workerIds,
      RepartitionCommandTOptions options)
    {
      this();
      this.fileId = fileId;
      setFileIdIsSet(true);
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public RepartitionCommand_args(RepartitionCommand_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.fileId = other.fileId;
      if (other.isSetWorkerIds()) {
        List<Integer> __this__workerIds = new ArrayList<Integer>(other.workerIds);
        this.workerIds = __this__workerIds;
      }
      if (other.isSetOptions()) {
        this.options = new RepartitionCommandTOptions(other.options);
      }
    }

    public RepartitionCommand_args deepCopy() {
      return new RepartitionCommand_args(this);
    }
    ...
    public RepartitionCommand_args setFileId(int fileId) {
      this.fileId = fileId;
      setFileIdIsSet(true);
      return this;
    }
    ...
    public int getWorkerIdsSize() {
      return (this.workerIds == null) ? 0 : this.workerIds.size();
    }

    public java.util.Iterator<Integer> getWorkerIdsIterator() {
      return (this.workerIds == null) ? null : this.workerIds.iterator();
    }

    public void addToWorkerIds(int elem) {
      if (this.workerIds == null) {
        this.workerIds = new ArrayList<Integer>();
      }
      this.workerIds.add(elem);
    }
    ...
    public RepartitionCommand_args setWorkerIds(List<Integer> workerIds) {
      this.workerIds = workerIds;
      return this;
    }

    public void unsetWorkerIds() {
      this.workerIds = null;
    }

    /** Returns true if field workerIds is set (has been assigned a value) and false otherwise */
    public boolean isSetWorkerIds() {
      return this.workerIds != null;
    }

    public void setWorkerIdsIsSet(boolean value) {
      if (!value) {
        this.workerIds = null;
      }
    }

    public RepartitionCommandTOptions getOptions() {
      return this.options;
    }

    public RepartitionCommand_args setOptions(RepartitionCommandTOptions options) {
      this.options = options;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case WORKER_IDS:
        if (value == null) {
          ...
          setWorkerIds((List<Integer>)value);
        }
        break;
      ...
      case OPTIONS:
        if (value == null) {
          ...
          setOptions((RepartitionCommandTOptions)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof RepartitionCommand_args)
        return this.equals((RepartitionCommand_args)that);
      return false;
    }

    public boolean equals(RepartitionCommand_args that) {
      if (that == null)
        return false;
      ...
      boolean this_present_workerIds = true && this.isSetWorkerIds();
      boolean that_present_workerIds = true && that.isSetWorkerIds();
      if (this_present_workerIds || that_present_workerIds) {
        if (!(this_present_workerIds && that_present_workerIds))
          return false;
        if (!this.workerIds.equals(that.workerIds))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_workerIds = true && (isSetWorkerIds());
      list.add(present_workerIds);
      if (present_workerIds)
        list.add(workerIds);
    ...
    @Override
    public int compareTo(RepartitionCommand_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
      ...
      lastComparison = Boolean.valueOf(isSetWorkerIds()).compareTo(other.isSetWorkerIds());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetWorkerIds()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.workerIds, other.workerIds);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("RepartitionCommand_args(");
      boolean first = true;
    ...
    private static class RepartitionCommand_argsStandardSchemeFactory implements SchemeFactory {
      public RepartitionCommand_argsStandardScheme getScheme() {
        return new RepartitionCommand_argsStandardScheme();
      }
    }

    private static class RepartitionCommand_argsStandardScheme extends StandardScheme<RepartitionCommand_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, RepartitionCommand_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.workerIds = new ArrayList<Integer>(_list8.size);
                  int _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = iprot.readI32();
                    struct.workerIds.add(_elem9);
                  }
                  iprot.readListEnd();
                }
                struct.setWorkerIdsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
            case 3: // OPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.options = new RepartitionCommandTOptions();
                struct.options.read(iprot);
                struct.setOptionsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, RepartitionCommand_args struct) throws org.apache.thrift.TException {
        struct.validate();
        ...
        oprot.writeFieldEnd();
        if (struct.workerIds != null) {
          oprot.writeFieldBegin(WORKER_IDS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.workerIds.size()));
            for (int _iter11 : struct.workerIds)
            {
    ...
    private static class RepartitionCommand_argsTupleSchemeFactory implements SchemeFactory {
      public RepartitionCommand_argsTupleScheme getScheme() {
        return new RepartitionCommand_argsTupleScheme();
      }
    }

    private static class RepartitionCommand_argsTupleScheme extends TupleScheme<RepartitionCommand_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, RepartitionCommand_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetFileId()) {
          optionals.set(0);
        }
        if (struct.isSetWorkerIds()) {
          optionals.set(1);
        }
        if (struct.isSetOptions()) {
          optionals.set(2);
        ...
        if (struct.isSetWorkerIds()) {
          {
            oprot.writeI32(struct.workerIds.size());
            for (int _iter12 : struct.workerIds)
            {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, RepartitionCommand_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(3);
        if (incoming.get(0)) {
          struct.fileId = iprot.readI32();
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.workerIds = new ArrayList<Integer>(_list13.size);
            int _elem14;
            for (int _i15 = 0; _i15 < _list13.size; ++_i15)
            {
              _elem14 = iprot.readI32();
              struct.workerIds.add(_elem14);
            }
          }
          struct.setWorkerIdsIsSet(true);
        }
  ...
  public static class RepartitionCommand_result implements org.apache.thrift.TBase<RepartitionCommand_result, RepartitionCommand_result._Fields>, java.io.Serializable, Cloneable, Comparable<RepartitionCommand_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RepartitionCommand_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new RepartitionCommand_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new RepartitionCommand_resultTupleSchemeFactory());
    }

    private RepartitionCommandTResponse success; // required
    private alluxio.thrift.AlluxioTException e; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RepartitionCommandTResponse.class)));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RepartitionCommand_result.class, metaDataMap);
    }

    public RepartitionCommand_result() {
    }

    public RepartitionCommand_result(
      RepartitionCommandTResponse success,
      alluxio.thrift.AlluxioTException e)
    {
      this();
      this.success = success;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public RepartitionCommand_result(RepartitionCommand_result other) {
      if (other.isSetSuccess()) {
        this.success = new RepartitionCommandTResponse(other.success);
      }
      if (other.isSetE()) {
        this.e = new alluxio.thrift.AlluxioTException(other.e);
      }
    ...
    public RepartitionCommand_result deepCopy() {
      return new RepartitionCommand_result(this);
    }
    ...
    public RepartitionCommandTResponse getSuccess() {
      return this.success;
    }

    public RepartitionCommand_result setSuccess(RepartitionCommandTResponse success) {
      this.success = success;
      return this;
    }
    ...
    public RepartitionCommand_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((RepartitionCommandTResponse)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof RepartitionCommand_result)
        return this.equals((RepartitionCommand_result)that);
      return false;
    }

    public boolean equals(RepartitionCommand_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(RepartitionCommand_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("RepartitionCommand_result(");
      boolean first = true;
    ...
    private static class RepartitionCommand_resultStandardSchemeFactory implements SchemeFactory {
      public RepartitionCommand_resultStandardScheme getScheme() {
        return new RepartitionCommand_resultStandardScheme();
      }
    }

    private static class RepartitionCommand_resultStandardScheme extends StandardScheme<RepartitionCommand_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, RepartitionCommand_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new RepartitionCommandTResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, RepartitionCommand_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class RepartitionCommand_resultTupleSchemeFactory implements SchemeFactory {
      public RepartitionCommand_resultTupleScheme getScheme() {
        return new RepartitionCommand_resultTupleScheme();
      }
    }

    private static class RepartitionCommand_resultTupleScheme extends TupleScheme<RepartitionCommand_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, RepartitionCommand_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, RepartitionCommand_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new RepartitionCommandTResponse();
