...
public final class FileInfo implements Serializable {
  ...
  protected FileInfo(alluxio.thrift.FileInfo fileInfo) {
    ...
    mKValueForSP = fileInfo.getKValueForSP();
  ...
  public FileInfo setKValueForSP(int kValueForSP) {
  ...
  protected alluxio.thrift.FileInfo toThrift() {
    ...
    alluxio.thrift.FileInfo info =
        ...
        mPersistenceState, mMountPoint, fileBlockInfos, ThriftUtils.toThrift(mTtlAction), mMountId, mKValueForSP);
    return info;
  }
