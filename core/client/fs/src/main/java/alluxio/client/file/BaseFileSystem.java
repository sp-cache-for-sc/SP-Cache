...
public class BaseFileSystem implements FileSystem {
  ...
  @Override
  public void spRepartition(boolean isParallel) throws AlluxioException, IOException{
    FileSystemMasterClient masterClient = mFileSystemContext.acquireMasterClient();
    try {
      masterClient.spRepartition(isParallel);
    }catch (Exception e) {
      throw e;
    } finally {
      mFileSystemContext.releaseMasterClient(masterClient);
  ...
  @Override
  public void getK() throws AlluxioException, IOException{
    FileSystemMasterClient masterClient = mFileSystemContext.acquireMasterClient();
    try {
      masterClient.getK();
    }catch (Exception e) {
