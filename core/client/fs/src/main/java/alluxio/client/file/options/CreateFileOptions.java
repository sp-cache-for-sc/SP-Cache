...
public final class CreateFileOptions {
  ...
  private CreateFileOptions() {
    ...
    mKValueForSP = Configuration.getInt(PropertyKey.USER_SP_K_DEFAULT);
  }
  ...
  public CreateFileOptions setKValueForSP(int kValueForSP) {
    mKValueForSP = kValueForSP;
    return this;
  }

  public int getKValueForSP() {
    return mKValueForSP;
  }
  ...
  public CreateFileTOptions toThrift() {
    ...
    options.setTtl(mTtl);
    options.setKValueForSP(mKValueForSP);
