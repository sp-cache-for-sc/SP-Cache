...
public class FileInStream extends InputStream
  ...
  public BlockInStream mCurrentBlockInStream;
  /**
   ...
   * @param options the client options
   */
  public FileInStream(URIStatus status, InStreamOptions options, FileSystemContext context) {
    mStatus = status;
  ...
  private int readInternal(byte[] b, int off, int len) throws IOException {
    ...
    //System.out.println("yinghao debug1:" + mCurrentBlockInStream.Source());
