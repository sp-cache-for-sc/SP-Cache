...
public final class OpenFileOptions {
  ...
  private OpenFileOptions() {
    ...
    mForSP = false; // if true, will record the access count.
  }
  ...
  public OpenFileOptions setForSP(boolean forSP) {
    mForSP = forSP;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(mCacheLocationPolicy, mReadType, mMaxUfsReadConcurrency, mForSP);
  }
